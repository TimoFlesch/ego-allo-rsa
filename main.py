...
from utils import fit_transform, front_frame, input_frame, input_label, RSA_predict
...
if __name__ == "__main__":
    ...
    # Loss and optimizer
    criterion = nn.L1Loss()
    optimizer = torch.optim.Adam(model2.parameters(), lr=learning_rate, weight_decay=learning_rate/100)
